...
export default function EntryModal({
  ...
  return (
    ...
    >
      <div className="bg-[var(--background)] rounded-2xl max-w-md w-full border-2 border-[var(--accent)]/20 my-8 flex flex-col max-h-[90vh]">
        <div className="flex items-center justify-between p-6 pb-0 mb-6">
          ...
          <button onClick={onClose} className="text-[var(--muted)] hover:text-[var(--foreground)]" aria-label="Zamknij">
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="entry-date" className="block text-[var(--foreground)] mb-2 font-semibold">Data *</label>
            <input
              id="entry-date"
              type="date"
              value={date}
          ...
          <div>
            <label htmlFor="entry-weight" className="block text-[var(--foreground)] mb-2 font-semibold">Waga (kg) *</label>
            <input
              id="entry-weight"
              type="number"
              step="0.1"
              ...
              className={`w-full bg-[var(--card-bg)] text-[var(--foreground)] rounded-xl px-4 py-3 border-2 outline-none ${
                error ? 'border-red-500 focus:border-red-500' : 'border-[var(--card-border)] focus:border-[var(--accent)]'
              }`}
            />
            {error && (
          ...
          <div>
            <label className="flex items-center gap-2 text-[var(--foreground)] mb-2 font-semibold">
              ...
              Kalorie {goal?.daily_calories_limit && <span className="text-[var(--muted)] font-normal">(cel: {goal.daily_calories_limit})</span>}
              {meals.length > 0 && <span className="text-[var(--accent)]/70 text-xs font-normal ml-auto">auto z posiłków</span>}
            </label>
          ...
          <div>
            <label className="flex items-center gap-2 text-[var(--foreground)] mb-2 font-semibold">
              ...
              Kroki {goal?.daily_steps_goal && <span className="text-[var(--muted)] font-normal">(cel: {goal.daily_steps_goal.toLocaleString()})</span>}
            </label>
          ...
          <div>
            ...
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={2}
              className="w-full bg-[var(--card-bg)] text-[var(--foreground)] rounded-xl px-4 py-3 border-2 border-[var(--card-border)] focus:border-[var(--accent)] outline-none resize-none" />
          </div>
          ...
          <div className="flex gap-3">
            {entry && onDelete && (
              <button
                ...
                className="bg-[var(--surface)] hover:bg-red-600 text-[var(--foreground)] hover:text-white font-semibold py-3 px-4 rounded-xl transition-colors flex items-center justify-center"
            ...
            <button
              ...
              className="flex-1 bg-[var(--accent)] hover:bg-[var(--accent-dark)] disabled:bg-[var(--surface)] disabled:cursor-not-allowed text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center"
            >
      ...
      {showDeleteConfirm && (
        ...
        >
          <div className="bg-[var(--card-bg)] rounded-2xl p-6 max-w-sm w-full border-2 border-red-500/30">
            ...
            <p id="delete-modal-desc" className="text-[var(--foreground)] mb-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={deleting}
                className="flex-1 bg-[var(--surface)] hover:bg-[var(--card-border)] text-[var(--foreground)] font-semibold py-3 rounded-xl transition-colors"
              >
                Anuluj
              </button>
              <button
                ...
                disabled={deleting}
                className="flex-1 bg-red-600 hover:bg-red-500 disabled:bg-[var(--surface)] text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2"
              >
                {deleting ? (

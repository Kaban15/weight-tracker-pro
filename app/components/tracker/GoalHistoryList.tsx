      ...
      <div className="bg-[var(--card-bg)] rounded-xl p-6 border-2 border-[var(--card-border)]">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--foreground)]">Historia celow</h3>
              <p className="text-[var(--muted)] text-sm">{history.length} zakonczonych celow</p>
            </div>
          </div>
        </div>
        ...
        {history.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-[var(--muted)]">Brak zakonczonych celow</p>
          ...
          <div className="space-y-3">
            {history.map((goal) => (
              <button
                ...
                className="w-full bg-[var(--background)] hover:bg-[var(--card-bg)] border border-[var(--card-border)] hover:border-[var(--accent)]/50 rounded-xl p-4 transition-all text-left group"
              >
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-sm ${
                          goal.weight_lost > 0 ? 'text-[var(--accent)]' : goal.weight_lost < 0 ? 'text-red-400' : 'text-[var(--muted)]'
                        }`}>
